...
public class FlowSumSortRunner extends Configured implements Tool {
...
//        String inputPath = "D:\\test\\hadoop_data\\topn_data\\in";
        String inputPath = "D:/test/hadoop_data/topn_data/out/part-r-00000";
        String outputPath = "D:/test/hadoop_data/topn_data/out/sorted/";
        ...
        int run = ToolRunner.run(new Configuration(), new FlowSumSortRunner(), paths);
